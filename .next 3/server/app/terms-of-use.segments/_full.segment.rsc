...
a:["$","$1","c",{"children":[["$","section",null,{"className":"section","children":["$","div",null,{"className":"container","children":[["$","p",null,{"className":"eyebrow","children":"Legal"}],["$","h1",null,{"className":"display","children":"Terms of Use"}],["$","p",null,{"className":"lead","children":"Terms should be migrated from WordPress and updated to reflect retailer-only ordering, payment before shipment, 5% GST, and flat-rate shipping."}]]}]}],null,["$","$L12",null,{"children":["$","$13",null,{"name":"Next.MetadataOutlet","children":"$@14"}]}]]}]
15:[]
b:"$W15"
