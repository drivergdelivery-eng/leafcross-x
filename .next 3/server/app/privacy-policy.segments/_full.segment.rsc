...
a:["$","$1","c",{"children":[["$","section",null,{"className":"section","children":["$","div",null,{"className":"container","children":[["$","p",null,{"className":"eyebrow","children":"Legal"}],["$","h1",null,{"className":"display","children":"Privacy Policy"}],["$","p",null,{"className":"lead","children":"Privacy policy content should be migrated from WordPress and reviewed for the new retailer-only Supabase application."}]]}]}],null,["$","$L12",null,{"children":["$","$13",null,{"name":"Next.MetadataOutlet","children":"$@14"}]}]]}]
15:[]
b:"$W15"
